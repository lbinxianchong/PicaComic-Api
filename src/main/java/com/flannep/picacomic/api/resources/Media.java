package com.flannep.picacomic.api.resources;

import net.sf.json.JSONObject;

/**
 * 代表每个文件对象
 * 一般来说，访问这些文件是不需要带完整的哔咔请求头的
 *
 * @author FlanN
 */
public class Media {
    ...
    public Media(JSONObject mediaJson) {
    ...
    public String getHostHeader() {
        return getFileServer().substring(getFileServer().lastIndexOf("/") + 1);
    }
